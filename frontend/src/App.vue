  ...
  <div v-else class="layout">
    ...
    <nav class="sidebar" :class="{ 'is-open': sidebarOpen }">
      <div class="sidebar-title">
        <a class="sidebar-brand" href="https://github.com/Easoncan/Bemby" target="_blank" rel="noopener noreferrer">
      ...
      <div class="sidebar-footer">
        ...
        <a class="github-link" href="https://github.com/Easoncan/Bemby" target="_blank" rel="noopener noreferrer">
